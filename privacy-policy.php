...
<!-- Intro Section Start  -->
<section class="intro intro-privacy pb-4 pt-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-heading"><span>Privacy</span> Policy</h2>
...
<section class="static-pages">
    <div class="container">
        <div class="row mb-5">
            <div class="col-md-12 para-cols">
                <p>At hemantsurgical.com, accessible from <a href="#">https://www.hemantsurgical.com/</a>, one of our
                    main priorities is
                    the privacy of our visitors. This Privacy Policy document contains types of information that are
                    collected and recorded by hemantsurgical.com and how we use it.</p>
                <p>If you have additional questions or require more information about our Privacy Policy, do not
                    hesitate to contact us.</p>
                <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website
                    with regards to the information that they shared and/or collect in hemantsurgical.com. This policy
                    is not applicable to any information collected offline or via channels other than this website.</p>
            </div>
        </div>
        <div class="row mb-5">
            <div class="col-md-12">
                <h2 class="company-heading">Consent</h2>
            </div>
            <div class="col-md-12 para-cols">
        ...
        <div class="row mb-5">
            <div class="col-md-12">
                <h2 class="company-heading">Information we collect</h2>
            </div>
            <div class="col-md-12 para-cols">
        ...
        <div class="row mb-5">
            <div class="col-md-12">
                <h2 class="company-heading">How we use your information</h2>
            </div>
            <div class="col-md-12 para-cols">
                ...
                <ul class="red-check">
                    ...
                    <li>Communicate with you, either directly or through one of our partners, including for customer
                        service, to provide
                        you with updates and other information relating to the website, and for marketing and
        ...
        <div class="row mb-5">
            <div class="col-md-12">
                <h2 class="company-heading">Log Files</h2>
            </div>
            <div class="col-md-12 para-cols">
                <p>hemantsurgical.com follows a standard procedure of using log files. These files log visitors when
        ...
        <div class="row mb-5">
            <div class="col-md-12">
                <h2 class="company-heading">Cookies and Web Beacons</h2>
            </div>
            <div class="col-md-12 para-cols">
                <p>Like any other website, hemantsurgical.com uses ‘cookies’. These cookies are used to store
        ...
        <div class="row mb-5">
            ...
            <div class="col-md-12 para-cols">
                ...
                <p>Note that hemantsurgical.com has no access to or control over these cookies that are used by
                    third-party advertisers.</p>
            </div>
        </div>
        <div class="row mb-5">
            <div class="col-md-12">
                <h2 class="company-heading">Third Party Privacy Policies</h2>
            </div>
            <div class="col-md-12 para-cols">
                <p>hemantsurgical.com’s Privacy Policy does not apply to other advertisers or websites. Thus, we are
        ...
        <div class="row mb-5">
            <div class="col-md-12">
                <h2 class="company-heading">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
            </div>
            <div class="col-md-12 para-cols">
                <p>Under the CCPA, among other rights, California consumers have the right to:</p>
                <!-- <div class="mission-points">
                    <p> <img src="assets/img/Group 13564.png" alt=""><span class="mission-p-para">Request that a
                    ...
                    <p> <img src="assets/img/Group 13564.png" alt=""><span class="mission-p-para">Request that a
                            business delete any personal data about the consumer that a business has collected.</span>
                    </p>
                    <p> <img src="assets/img/Group 13564.png" alt=""><span class="mission-p-para">Request that a
                            business that sells a consumer’s personal data, not sell the consumer’s personal data.
                        </span></p>
                    <p> <img src="assets/img/Group 13564.png" alt=""><span class="mission-p-para">If you make a
                            request, we have one month to respond to you. If you would like to exercise any of
                            these rights, please contact us. </span></p>
                </div> -->
                 <ul class="red-check">
                    ...
                    <li>Request that a
                            business delete any personal data about the consumer that a business has collected.</li>
                    <li>Request that a
                            business that sells a consumer’s personal data, not sell the consumer’s personal data.</li>
                    <li>If you make a
                            request, we have one month to respond to you. If you would like to exercise any of
        ...
        <div class="row mb-5">
            <div class="col-md-12">
                <h2 class="company-heading">GDPR Data Protection Rights</h2>
            </div>
            <div class="col-md-12 para-cols">
                ...
                <!-- <div class="mission-points">
                    <p> <img src="assets/img/Group 13564.png" alt=""><span class="mission-p-para"><b>The right to access
                                –</b> You have the right to request copies of your personal data. We may charge you a
                            small fee for this service.</span></p>
                    <p> <img src="assets/img/Group 13564.png" alt=""><span class="mission-p-para"> <b>The right to
                                rectification –</b> You have the right to request that we correct any information you
                            believe is inaccurate. You also have the right to request that we complete the information
                            you believe is incomplete.</span></p>
                    <p> <img src="assets/img/Group 13564.png" alt=""><span class="mission-p-para"><b>The right to
                                erasure –</b> You have the right to request that we erase your personal data, under
                            certain conditions. </span></p>
                    <p> <img src="assets/img/Group 13564.png" alt=""><span class="mission-p-para"><b>The right to
                                restrict processing –</b> You have the right to request that we restrict the processing
                            of your personal data, under certain conditions. </span></p>
                    <p> <img src="assets/img/Group 13564.png" alt=""><span class="mission-p-para"><b>The right to object
                                to processing –</b>You have the right to object to our processing of your personal data,
                            under certain conditions. </span></p>
                    <p> <img src="assets/img/Group 13564.png" alt=""><span class="mission-p-para"><b>The right to data
                                portability –</b>You have the right to request that we transfer the data that we have
                ...
                <ul class="red-check">
                    ...
                    <li>The right to
                                rectification – You have the right to request that we correct any information you
                            believe is inaccurate. You also have the right to request that we complete the information
                            you believe is incomplete.</li>
                    <li>The right to
                                erasure – You have the right to request that we erase your personal data, under
                            certain conditions.</li>                    
                    <li>The right to
                                restrict processing – You have the right to request that we restrict the processing
                            of your personal data, under certain conditions.</li>
                    <li>The right to object
                                to processing –You have the right to object to our processing of your personal data,
                            under certain conditions.</li>
                    <li>The right to data
        ...
        <div class="row mb-5">
            <div class="col-md-12">
                <h2 class="company-heading">Children’s Information</h2>
            </div>
            <div class="col-md-12 para-cols">
                ...
                <p>hemantsurgical.com does not knowingly collect any Personal Identifiable Information from children
