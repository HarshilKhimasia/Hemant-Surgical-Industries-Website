...
<!-- Intro Section Start  -->
<section class="intro intro-about-us pb-4 pt-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-heading"><span>Terms </span>and Conditions</h2>
    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col-md-12 para-cols">
                <p>Welcome to Hemant Surgical!</p>
                <p>These terms and conditions outline the rules and regulations for the use of Hemant Surgical
                    Industries Ltd’s Website, located at https://www.hemantsurgical.com/.
                    By accessing this website we assume you accept these terms and conditions. Do not continue to use
                    Hemant Surgical if you do not agree to take all of the terms and conditions stated on this page.</p>
        ...
        <div class="row mb-5">
            <div class="col-md-12">
                <h2 class="company-heading">Cookies</h2>
            </div>
            <div class="col-md-12 para-cols">
                <p>We employ the use of cookies. By accessing Hemant Surgical, you agreed to use cookies in agreement
                    with Hemant Surgical Industries Ltd’s Privacy Policy.</p>
        ...
        <div class="row mb-5">
            <div class="col-md-12">
                <h2 class="company-heading">License</h2>
            </div>
            <div class="col-md-12 para-cols">
                <p>Unless otherwise stated, Hemant Surgical Industries Ltd and/or its licensors own the intellectual
                    property rights for all material on Hemant Surgical. All intellectual property rights are reserved.
                    You may access this from Hemant Surgical for your own personal use subjected to restrictions set in
                    these terms and conditions.</p>
                <p>You must not:</p>
                <ul class="red-check">
                    <li>Republish material from Hemant Surgical</li>
                    <li>Sell, rent or sub-license material from Hemant Surgical</li>
                    <li>Reproduce, duplicate or copy material from Hemant Surgical</li>
                    <li>Redistribute content from Hemant Surgical</li>
                </ul>
                <p>This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the help of
                    the Terms And Conditions Generator.</p>
                <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                    certain areas of the website. Hemant Surgical Industries Ltd does not filter, edit, publish or
                    review Comments prior to their presence on the website. Comments do not reflect the views and
                    opinions of Hemant Surgical Industries Ltd,its agents and/or affiliates. Comments reflect the views
                    and opinions of the person who post their views and opinions. To the extent permitted by applicable
                    laws, Hemant Surgical Industries Ltd shall not be liable for the Comments or for any liability,
                ...
                <p>Hemant Surgical Industries Ltd reserves the right to monitor all Comments and to remove any Comments
                ...
                <ul class="red-check">
                    ...
                    <li>The Comments do not
                            invade any intellectual property right, including without limitation copyright, patent or
                            trademark of any third party;</li>
                    <li>The Comments do not
                            contain any defamatory, libelous, offensive, indecent or otherwise unlawful material which
                            is an invasion of privacy</li>
                    <li>The Comments will not
                            be used to solicit or promote business or custom or present commercial activities or
                            unlawful activity.</li>
                </ul>
                <p>You hereby grant Hemant Surgical Industries Ltd a non-exclusive license to use, reproduce, edit and
        ...
        <div class="row mb-5">
            <div class="col-md-12">
                <h2 class="company-heading">Hyperlinking to our Content</h2>
            </div>
            <div class="col-md-12 para-cols">
                ...
                <ul class="red-check">
                    ...
                    <li>System wide
                            Accredited Businesses except soliciting non-profit organizations, charity shopping malls,
                ...
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not make
                    ...
                    the absence of Hemant Surgical Industries Ltd; and (d) the link is in the context of general
                ...
                <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                    website, you must inform us by sending an e-mail to Hemant Surgical Industries Ltd. Please include
                ...
                <ul class="red-check">
                    ...
                    <li>By use of any other
                            description of our Website being linked to that makes sense within the context and format of
                            content on the linking party’s site.</li>
                </ul>
                <p>No use of Hemant Surgical Industries Ltd’s logo or other artwork will be allowed for linking absent a
                    trademark license agreement.</p>
            </div>
        </div>
        <div class="row mb-5">
            <div class="col-md-12">
                <h2 class="company-heading">iFrames</h2>
            </div>
            <div class="col-md-12 para-cols">
        ...
        <div class="row mb-5">
            <div class="col-md-12">
                <h2 class="company-heading">Content Liability</h2>
            </div>
            <div class="col-md-12 para-cols">
        ...
        <div class="row mb-5">
            <div class="col-md-12">
                <h2 class="company-heading">Reservation of Rights</h2>
            </div>
            <div class="col-md-12 para-cols">
        ...
        <div class="row mb-5">
            <div class="col-md-12">
                <h2 class="company-heading">Removal of links from our website</h2>
            </div>
            <div class="col-md-12 para-cols">
        ...
        <div class="row mb-5">
            <div class="col-md-12">
                <h2 class="company-heading">Disclaimer</h2>
            </div>
            <div class="col-md-12 para-cols">
